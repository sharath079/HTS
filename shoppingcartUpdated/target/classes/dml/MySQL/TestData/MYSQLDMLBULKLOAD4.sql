 ...
 UPDATE CartItem SET userCartId = cartItem;


 UPDATE CartItem SET productId = cartItem;


 UPDATE CartItem SET productQuantity = cartItem;


 UPDATE CartItem SET productUnitPrice = cartItem;


 UPDATE CartItem SET subTotalAmount = cartItem;


 UPDATE CartItem SET grandTotal = cartItem;



 UPDATE Products SET productName = CONCAT('FIELD_NAME.toUpperCase()', products");





 UPDATE Products SET productDescription = CONCAT('FIELD_NAME.toUpperCase()', products");





 UPDATE Products SET productPrice = products;


 UPDATE Products SET productUnitType = CONCAT('FIELD_NAME.toUpperCase()', products");
 ...
 UPDATE Orders SET userCartId = orders;


 UPDATE Orders SET orderNo = orders;


 UPDATE Orders SET orderDate = CURDATE();
 ...
 UPDATE Orders SET orderAmount = orders;



 UPDATE OrderItem SET orderId = orderItem;


 UPDATE OrderItem SET productId = orderItem;


 UPDATE OrderItem SET productQuantity = orderItem;


 UPDATE OrderItem SET productUnitPrice = orderItem;


 UPDATE OrderItem SET subTotalAmt = orderItem;
