...
*/			String loginUserType = userSessionInfo.get("loginUserType").getAsString();
    ...
    public static int configureSysadminPrivileges(Session masterSession, int userInfoId) throws Exception
    {
        try
        {
			...
			com.shoppingcart.bean.PrivilegeGroup privilegeGroup = new com.shoppingcart.bean.PrivilegeGroup();
			...
			privilegeGroup = (com.shoppingcart.bean.PrivilegeGroup)privilegeGroupControllerImpl.getManagedBean();
			...
			for(int i =0; i< sysadminPrivilegesList.size(); i++)
			{
				...
				com.shoppingcart.bean.PrivilegeGroupItems privilegeGroupItems = new com.shoppingcart.bean.PrivilegeGroupItems();
			...
			com.shoppingcart.controller.forms.impl.EmployeeRolesControllerImpl  employeeRolesControllerImpl = new com.shoppingcart.controller.forms.impl.EmployeeRolesControllerImpl(masterSession, userSessionInfo);
			com.shoppingcart.bean.EmployeeRoles employeeRoles = new com.shoppingcart.bean.EmployeeRoles();
			...
			employeeRoles = (com.shoppingcart.bean.EmployeeRoles)employeeRolesControllerImpl.getManagedBean();
