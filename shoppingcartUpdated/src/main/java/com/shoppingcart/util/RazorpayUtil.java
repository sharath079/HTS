...
public class RazorpayUtil
{
	...
	public static String getRazorpayPaymentOrderId(Integer amountInPaisa, int referenceId)
	{
		try
		{
			String RazorPayKeyId = com.shoppingcart.util.SettingsUtil.getRazorPayKeyId();
			String RazorPayKeyValue = com.shoppingcart.util.SettingsUtil.getRazorPayKeyValue();
			...
			JsonObject httpRequestInfo = com.shoppingcart.request.service.HttpUtil.sendHttpPostRequest("https://api.razorpay.com/v1/orders", nvps, additionalParams);
	...
	public static JsonObject getRazorpayTransactionStatus(String referenceId)
	{
		...
		try
		{
			String RazorPayKeyId = com.shoppingcart.util.SettingsUtil.getRazorPayKeyId();
			String RazorPayKeyValue = com.shoppingcart.util.SettingsUtil.getRazorPayKeyValue();
			String RazorPayAccountNumber = com.shoppingcart.util.SettingsUtil.getRazorPayAccountNumber();
			JsonObject additionalParams = new JsonObject();
			additionalParams.addProperty("RazorPayKeyId", RazorPayKeyId);
			additionalParams.addProperty("RazorPayKeyValue", RazorPayKeyValue);
