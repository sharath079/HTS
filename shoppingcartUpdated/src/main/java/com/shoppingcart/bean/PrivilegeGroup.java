...
public class PrivilegeGroup extends RulesBean implements java.io.Serializable
{
	...
	@Column(name = "privilegeGroupName")
	private java.lang.String privilegeGroupName;
	
	@Column(name = "privilegeCode")
	private java.lang.String privilegeCode;
	
	@Column(name = "applicableUserType")
	private java.lang.String applicableUserType;
	
	@Column(name = "selfServiceUser")
	private java.lang.String selfServiceUser;
	
	@Column(name = "privilegeGroupDescription")
	private java.lang.String privilegeGroupDescription;
	...
	public void setSelfServiceUser(String selfServiceUser)
	{
		this.selfServiceUser = selfServiceUser;
	}
	
	public String getPrivilegeGroupDescription()
	{
		return this.privilegeGroupDescription;
	}
	public void setPrivilegeGroupDescription(String privilegeGroupDescription)
	{
	...
	public JsonObject getDataObject(boolean fetchForLookup, Session session)
	{
		...
		{
			dataObject.addProperty("privilegeGroupName", privilegeGroupName);
		}
		else
		{
			dataObject.addProperty("privilegeGroupName", "");
		}
		
		if(privilegeCode!=null)
		{
			dataObject.addProperty("privilegeCode", privilegeCode);
		}
		else
		{
			dataObject.addProperty("privilegeCode", "");
		}
		
		if(applicableUserType!=null)
		{
			dataObject.addProperty("applicableUserType", applicableUserType);
		}
		else
		{
			dataObject.addProperty("applicableUserType", "");
		}
		
		if(selfServiceUser!=null)
		{
			dataObject.addProperty("selfServiceUser", selfServiceUser);
		}
		else
		{
			dataObject.addProperty("selfServiceUser", "");
		}
		
		if(privilegeGroupDescription!=null)
		{
			dataObject.addProperty("privilegeGroupDescription", privilegeGroupDescription);
		}
		else
		{
			dataObject.addProperty("privilegeGroupDescription", "");
		}
	...
	public String getLookupDisplayText(Session session)
	{
		...
		if(privilegeGroupName!=null)
		{
			displayText += privilegeGroupName;
		}
	...
	public Object getPropertyValue(Session session, String popertyNameEL, JsonObject dataObject)
	{
		try
		{
			...
			{
				Method instanceMethod = PrivilegeGroup.class.getMethod("get" + popertyNameEL);
