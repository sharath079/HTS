 ...
 */
@Entity
@Table(name = "TaskLayoutParameters")
public class TaskLayoutParameters extends RulesBean implements java.io.Serializable
{
	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue
	@Column(name = "taskLayoutParametersId")
	private java.lang.Integer taskLayoutParametersId;
	...
	private java.lang.String parameterValueType;
	...
	public TaskLayoutParameters()
	{
	}
	public Integer getTaskLayoutParametersId()
	{
		return this.taskLayoutParametersId;
	}
	public void setTaskLayoutParametersId(Integer taskLayoutParametersId)
	{
		this.taskLayoutParametersId = taskLayoutParametersId;
	}
	...
	public JsonObject getDataObject(boolean fetchForLookup, Session session)
	{
		...
		{
			dataObject.addProperty("parameterName", parameterName);
		}
		else
		{
			dataObject.addProperty("parameterName", "");
		}
		
		if(parameterValueType!=null)
		{
			dataObject.addProperty("parameterValueType", parameterValueType);
		}
		else
		{
			dataObject.addProperty("parameterValueType", "");
		}
		
		if(parameterValue!=null)
		{
			dataObject.addProperty("parameterValue", parameterValue);
		}
		else
		{
			dataObject.addProperty("parameterValue", "");
		}
		...
		{
			com.shoppingcart.bean.TaskInfo  taskInfo = (com.shoppingcart.bean.TaskInfo) session.get(com.shoppingcart.bean.TaskInfo.class, taskInfoId);   
			JsonObject taskInfoObj = taskInfo.getDataObject(true, session);
			dataObject.addProperty("taskInfoDisplayVal", taskInfoObj.get("lookupDisplayText").getAsString());
	...
	public Object getPropertyValue(Session session, String popertyNameEL, JsonObject dataObject)
	{
		try
		{
			...
			{
				Method instanceMethod = TaskLayoutParameters.class.getMethod("get" + popertyNameEL);
