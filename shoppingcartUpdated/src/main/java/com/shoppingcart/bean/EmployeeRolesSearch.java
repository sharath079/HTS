 ...
 */
public class EmployeeRolesSearch extends RulesBean implements java.io.Serializable
{
	/*private static final long serialVersionUID = 1L;
	private java.lang.Integer employeeRolesId ;
		private PrivilegeGroup privilegeGroup $$HASH_SET$$;
	private $$JAVA_FIELD_TYPE$$ description $$HASH_SET$$;

	public EmployeeRolesSearch()
	{
	}
	public java.lang.Integer getEmployeeRolesSearchId()
	{
		return this.employeeRolesId;
	}
	public void setEmployeeRolesSearchId(java.lang.Integer messageQueueId)
	{
	...
	public $$JAVA_FIELD_TYPE$$ getDescription()
	{
		return this.description;
	}
	public void setDescription($$JAVA_FIELD_TYPE$$ description)
	{
