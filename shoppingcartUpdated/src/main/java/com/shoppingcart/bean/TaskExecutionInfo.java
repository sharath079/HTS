 ...
 */
@Entity
@Table(name = "TaskExecutionInfo")
public class TaskExecutionInfo extends RulesBean implements java.io.Serializable
{
	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue
	@Column(name = "taskExecutionInfoId")
	...
	@Column(name = "taskTimeCalculationType")
	private java.lang.String taskTimeCalculationType;
	...
	public Integer getTaskExecutionInfoId()
	{
		return this.taskExecutionInfoId;
	}
	public void setTaskExecutionInfoId(Integer taskExecutionInfoId)
	{
		this.taskExecutionInfoId = taskExecutionInfoId;
	}
		
	public String getTaskTimeCalculationType()
	{
		return this.taskTimeCalculationType;
	}
	public void setTaskTimeCalculationType(String taskTimeCalculationType)
	{
	...
	public JsonObject getDataObject(boolean fetchForLookup, Session session)
	{
		...
		{
			dataObject.addProperty("taskTimeCalculationType", taskTimeCalculationType);
		}
		else
		{
			dataObject.addProperty("taskTimeCalculationType", "");
		}
	...
	public Object getPropertyValue(Session session, String popertyNameEL, JsonObject dataObject)
	{
		try
		{
			...
			{
				Method instanceMethod = TaskExecutionInfo.class.getMethod("get" + popertyNameEL);
