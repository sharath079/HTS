...
@Entity
@Table(name = "Products")
public class Products extends RulesBean implements java.io.Serializable
{
	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue
	@Column(name = "productsId")
	private java.lang.Integer productsId;
	...
	@Column(name = "productUnitType")
	private java.lang.String productUnitType;
	...
	public JsonObject getDataObject(boolean fetchForLookup, Session session)
	{
		...
		if(productName!=null)
		{
			dataObject.addProperty("productName", productName);
		}
		else
		{
			dataObject.addProperty("productName", "");
		}
		
		if(productDescription!=null)
		{
			dataObject.addProperty("productDescription", productDescription);
		}
		else
		{
			dataObject.addProperty("productDescription", "");
		}
		
		dataObject.addProperty("productPrice", productPrice);
		
		if(productUnitType!=null)
		{
			dataObject.addProperty("productUnitType", productUnitType);
		}
		else
		{
			dataObject.addProperty("productUnitType", "");
		}
	...
	public Object getPropertyValue(Session session, String popertyNameEL, JsonObject dataObject)
	{
		try
		{
			...
			{
				Method instanceMethod = Products.class.getMethod("get" + popertyNameEL);
