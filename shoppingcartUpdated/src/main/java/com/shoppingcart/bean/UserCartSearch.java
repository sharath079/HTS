 ...
 */
public class UserCartSearch extends RulesBean implements java.io.Serializable
{
	/*private static final long serialVersionUID = 1L;
	private java.lang.Integer userCartId ;
		private $$JAVA_FIELD_TYPE$$ cartCreationTime $$HASH_SET$$;
	private $$JAVA_FIELD_TYPE$$ cartCheckoutTime $$HASH_SET$$;

	public UserCartSearch()
	{
	}
	public java.lang.Integer getUserCartSearchId()
	{
		return this.userCartId;
	}
	public void setUserCartSearchId(java.lang.Integer messageQueueId)
	{
		this.userCartId = userCartId;
	}
		public $$JAVA_FIELD_TYPE$$ getCartCreationTime()
	{
		return this.cartCreationTime;
	}
	public void setCartCreationTime($$JAVA_FIELD_TYPE$$ cartCreationTime)
	{
		this.cartCreationTime = cartCreationTime;
	}
	public $$JAVA_FIELD_TYPE$$ getCartCheckoutTime()
	{
		return this.cartCheckoutTime;
	}
	public void setCartCheckoutTime($$JAVA_FIELD_TYPE$$ cartCheckoutTime)
	{
