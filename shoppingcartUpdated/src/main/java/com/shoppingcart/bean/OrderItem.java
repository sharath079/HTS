...
public class OrderItem extends RulesBean implements java.io.Serializable
{
	...
	@Column(name = "subTotalAmt")
	private java.lang.Integer subTotalAmt;
	...
	public JsonObject getDataObject(boolean fetchForLookup, Session session)
	{
		...
		dataObject.addProperty("subTotalAmt", subTotalAmt);
	...
	public Object getPropertyValue(Session session, String popertyNameEL, JsonObject dataObject)
	{
		try
		{
			...
			{
				Method instanceMethod = OrderItem.class.getMethod("get" + popertyNameEL);
