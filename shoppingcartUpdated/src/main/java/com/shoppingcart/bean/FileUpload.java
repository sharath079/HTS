...
public class FileUpload extends RulesBean implements java.io.Serializable
{
	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue
	@Column(name = "fileUploadId")
	private java.lang.Integer fileUploadId;
	@Column(name = "fileName")
	private java.lang.String fileName;
	@Column(name = "fileBlob")
	private java.sql.Blob fileBlob;
	...
	public java.sql.Blob getFileBlob()
	{
		return this.fileBlob;
	}
	public void setFileBlob(java.sql.Blob fileBlob)
	{
	...
	public JsonObject getDataObject(boolean fetchForLookup, Session session)
	{
		...
		dataObject.addProperty("fileUploadId", fileUploadId);
		if(fileName!=null)
		{
		...
		{
			dataObject.addProperty("fileName", "");
		}
		if(fileBlob!=null)
		{
			dataObject.addProperty("fileBlob", fileBlob.toString());
		}
		else
		{
			dataObject.addProperty("fileBlob", "");
		}
	...
	public Object getPropertyValue(Session session, String popertyNameEL, JsonObject dataObject)
	{
		try
		{
			...
			{
				Method instanceMethod = FileUpload.class.getMethod("get" + popertyNameEL);
