...
public class ConfigProperties extends RulesBean implements java.io.Serializable
{
	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue
	@Column(name = "configPropertiesId")
	...
	public Integer getConfigPropertiesId()
	{
		return this.configPropertiesId;
	}
	public void setConfigPropertiesId(Integer configPropertiesId)
	{
	...
	public JsonObject getDataObject(boolean fetchForLookup, Session session)
	{
		...
		{
			dataObject.addProperty("propertyName", propertyName);
		}
		else
		{
			dataObject.addProperty("propertyName", "");
		}
		
		if(propertyValue!=null)
		{
			dataObject.addProperty("propertyValue", propertyValue);
		}
		else
		{
			dataObject.addProperty("propertyValue", "");
		}
	...
	public Object getPropertyValue(Session session, String popertyNameEL, JsonObject dataObject)
	{
		try
		{
			...
			{
				Method instanceMethod = ConfigProperties.class.getMethod("get" + popertyNameEL);
