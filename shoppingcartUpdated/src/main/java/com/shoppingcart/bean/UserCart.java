...
@Entity
@Table(name = "UserCart")
public class UserCart extends RulesBean implements java.io.Serializable
{
	...
	@Column(name = "cartCreationTime")
	private Time cartCreationTime;
	
	@Column(name = "cartCheckoutTime")
	private Time cartCheckoutTime;
	...
	public Time getCartCreationTime()
	{
		return this.cartCreationTime;
	}
	public void setCartCreationTime(Time cartCreationTime)
	{
		this.cartCreationTime = cartCreationTime;
	}
	
	public Time getCartCheckoutTime()
	{
		return this.cartCheckoutTime;
	}
	public void setCartCheckoutTime(Time cartCheckoutTime)
	{
	...
	public JsonObject getDataObject(boolean fetchForLookup, Session session)
	{
		...
		{
			dataObject.addProperty("cartCreationTime", CommonUtil.getTimeInRegular12HoursFormatWithSeconds(cartCreationTime));
		}
		else
		{
			dataObject.addProperty("cartCreationTime", "");
		}
		
		if(cartCheckoutTime!=null)
		{
			dataObject.addProperty("cartCheckoutTime", CommonUtil.getTimeInRegular12HoursFormatWithSeconds(cartCheckoutTime));
		}
		else
		{
			dataObject.addProperty("cartCheckoutTime", "");
		}
	...
	public Object getPropertyValue(Session session, String popertyNameEL, JsonObject dataObject)
	{
		try
		{
			...
			{
				Method instanceMethod = UserCart.class.getMethod("get" + popertyNameEL);
