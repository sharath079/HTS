...
{
	private static final Logger logger = Logger.getLogger(LoginSessionInfoControllerImpl.class);
    public LoginSessionInfoControllerImpl(JsonObject userSessionInfo, Session organisationSession)
    {
