...
import com.shoppingcart.controller.forms.base.EmailAttachmentLayoutLabel;
import com.shoppingcart.controller.forms.base.EmailAttachmentLayoutControllerBase;
 ...
 * 
 */
/*@ManagedBean(name = "EmailAttachmentLayoutControllerImpl")
@RequestScoped*/
public class EmailAttachmentLayoutControllerImpl extends EmailAttachmentLayoutControllerBase 
{
	public EmailAttachmentLayoutControllerImpl(Session session)
	{
		super(session);
	}
	public EmailAttachmentLayoutControllerImpl(Session session, JsonObject standardReqParams)
	{
		super(session, standardReqParams);
	}
	public EmailAttachmentLayoutControllerImpl()
	{
		super();
	}
	...
	public void doAfterEntityLoadedImpl(EmailAttachmentLayout emailAttachmentLayout, JsonObject initParamsInfo)
	{
		//Custom handling	
	}
	...
	public JsonObject doExecuteAPIRequestImpl(String apiName, JsonObject emailAttachmentLayoutDataObject, EmailAttachmentLayout emailAttachmentLayout)
	{
		// Custom handling
	...
	public void doAfterLookupRowSelectedImpl(EmailAttachmentLayout emailAttachmentLayout, String attributeName)
	{
		//Custom handling	
	}
	public void doAfterSelectOptionChangedImpl(EmailAttachmentLayout emailAttachmentLayout, String attributeName)
	{
		//Custom handling	
	}
