...
import com.shoppingcart.bean.Organisations;
import com.shoppingcart.controller.forms.base.OrganisationsLabel;
...
public abstract class OrganisationsControllerBase extends BusinessRulesController
{
	...
	{
		com.shoppingcart.bean.Organisations entityBean = (Organisations)entityObject;
	...
	
	{
		...
		try
		{
			for (int i =0; i < organisationsList.size(); i++)
			{
				...
				com.shoppingcart.controller.forms.impl.OrganisationsControllerImpl organisationsImplObj = new com.shoppingcart.controller.forms.impl.OrganisationsControllerImpl(session, getUserSessionInfo());				
