...
import com.shoppingcart.controller.forms.base.TaskSentInfoControllerBase;
 ...
 * 
 */
/*@ManagedBean(name = "TaskSentInfoControllerImpl")
@RequestScoped*/
public class TaskSentInfoControllerImpl extends TaskSentInfoControllerBase 
{
	public TaskSentInfoControllerImpl(Session session)
	{
		super(session);
	}
	public TaskSentInfoControllerImpl(Session session, JsonObject standardReqParams)
	{
	...
	public void doAfterEntityLoadedImpl(TaskSentInfo taskSentInfo, JsonObject initParamsInfo)
	{
		//Custom handling	
	}
	...
	public JsonObject doExecuteAPIRequestImpl(String apiName, JsonObject taskSentInfoDataObject, TaskSentInfo taskSentInfo)
	{
		// Custom handling
	...
	public void doAfterLookupRowSelectedImpl(TaskSentInfo taskSentInfo, String attributeName)
	{
		//Custom handling	
	}
	public void doAfterSelectOptionChangedImpl(TaskSentInfo taskSentInfo, String attributeName)
	{
		//Custom handling	
	}
