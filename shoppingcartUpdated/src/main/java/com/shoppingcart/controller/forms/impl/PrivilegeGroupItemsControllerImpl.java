...
import com.shoppingcart.controller.forms.base.PrivilegeGroupItemsLabel;
import com.shoppingcart.controller.forms.base.PrivilegeGroupItemsControllerBase;
 ...
 * 
 */
/*@ManagedBean(name = "PrivilegeGroupItemsControllerImpl")
@RequestScoped*/
public class PrivilegeGroupItemsControllerImpl extends PrivilegeGroupItemsControllerBase 
{
	public PrivilegeGroupItemsControllerImpl(Session session)
	{
		super(session);
	}
	public PrivilegeGroupItemsControllerImpl(Session session, JsonObject standardReqParams)
	{
		super(session, standardReqParams);
	}
	public PrivilegeGroupItemsControllerImpl()
	{
		super();
	}
	...
	public void doAfterEntityLoadedImpl(PrivilegeGroupItems privilegeGroupItems, JsonObject initParamsInfo)
	{
		//Custom handling	
	}
	...
	public JsonObject doExecuteAPIRequestImpl(String apiName, JsonObject privilegeGroupItemsDataObject, PrivilegeGroupItems privilegeGroupItems)
	{
		// Custom handling
	...
	public void doAfterLookupRowSelectedImpl(PrivilegeGroupItems privilegeGroupItems, String attributeName)
	{
		//Custom handling	
	}
	public void doAfterSelectOptionChangedImpl(PrivilegeGroupItems privilegeGroupItems, String attributeName)
	{
		//Custom handling	
	}
