...
public abstract class ConfigPropertiesControllerBase extends BusinessRulesController
{
	...
	{
		com.shoppingcart.bean.ConfigProperties entityBean = (ConfigProperties)entityObject;
	...
	
	{
		...
		try
		{
			for (int i =0; i < configPropertiesList.size(); i++)
			{
				...
				com.shoppingcart.controller.forms.impl.ConfigPropertiesControllerImpl configPropertiesImplObj = new com.shoppingcart.controller.forms.impl.ConfigPropertiesControllerImpl(session, getUserSessionInfo());				
