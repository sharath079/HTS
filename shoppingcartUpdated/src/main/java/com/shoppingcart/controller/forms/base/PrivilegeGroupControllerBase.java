...
//
import com.shoppingcart.bean.PrivilegeGroupItems;
...
import com.shoppingcart.controller.forms.base.PrivilegeGroupLabel;
...
public abstract class PrivilegeGroupControllerBase extends BusinessRulesController
{
	...
	{
		com.shoppingcart.bean.PrivilegeGroup entityBean = (PrivilegeGroup)entityObject;
		...
		if(privilegeGroupListObject!=null && privilegeGroupListObject.has("success") && privilegeGroupListObject.get("success").getAsInt()==1)
		{
			...
			for (int i =0; i< privilegeGroupList.size(); i++)
			{
				...
				int privilegeGroupId = privilegeGroupDataObject.get("privilegeGroupId").getAsInt();
								com.shoppingcart.controller.forms.impl.PrivilegeGroupItemsControllerImpl privilegeGroupItemsImplObj = new com.shoppingcart.controller.forms.impl.PrivilegeGroupItemsControllerImpl(getDBSession(), getUserSessionInfo());
	...
	public int  areSomeRecordsUploaded(JsonObject previousRetryCountMap, JsonObject retryCountMap) throws Exception
	{
		...
		if(retryCount<previousRetryCount)
		{
			return 1;
	    		...
	    		com.shoppingcart.controller.forms.impl.PrivilegeGroupItemsControllerImpl privilegeGroupItemsImplObj = new com.shoppingcart.controller.forms.impl.PrivilegeGroupItemsControllerImpl(getDBSession());
	...
	
	{
		...
		try
		{
			for (int i =0; i < privilegeGroupList.size(); i++)
			{
				...
				com.shoppingcart.controller.forms.impl.PrivilegeGroupControllerImpl privilegeGroupImplObj = new com.shoppingcart.controller.forms.impl.PrivilegeGroupControllerImpl(session, getUserSessionInfo());				
			    ...
			    {
				    JsonArray privilegeGroupItemsList = privilegeGroup.get("privilegeGroupItemsList").getAsJsonArray();
					com.shoppingcart.controller.forms.impl.PrivilegeGroupItemsControllerImpl privilegeGroupItemsImplObj = new com.shoppingcart.controller.forms.impl.PrivilegeGroupItemsControllerImpl(session, getUserSessionInfo());
