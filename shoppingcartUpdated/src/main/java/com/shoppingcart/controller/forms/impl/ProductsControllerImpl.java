...
import com.shoppingcart.controller.forms.base.ProductsControllerBase;
 ...
 * 
 */
/*@ManagedBean(name = "ProductsControllerImpl")
@RequestScoped*/
public class ProductsControllerImpl extends ProductsControllerBase 
{
	public ProductsControllerImpl(Session session)
	{
		super(session);
	}
	public ProductsControllerImpl(Session session, JsonObject standardReqParams)
	{
	...
	public void doAfterEntityLoadedImpl(Products products, JsonObject initParamsInfo)
	{
		//Custom handling	
	}
	...
	public JsonObject doExecuteAPIRequestImpl(String apiName, JsonObject productsDataObject, Products products)
	{
		// Custom handling
	...
	public void doAfterLookupRowSelectedImpl(Products products, String attributeName)
	{
		//Custom handling	
	}
	public void doAfterSelectOptionChangedImpl(Products products, String attributeName)
	{
		//Custom handling	
	}
