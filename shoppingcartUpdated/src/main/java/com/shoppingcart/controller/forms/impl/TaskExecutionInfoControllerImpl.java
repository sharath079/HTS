...
import com.shoppingcart.controller.forms.base.TaskExecutionInfoLabel;
import com.shoppingcart.controller.forms.base.TaskExecutionInfoControllerBase;
 ...
 * 
 */
/*@ManagedBean(name = "TaskExecutionInfoControllerImpl")
@RequestScoped*/
public class TaskExecutionInfoControllerImpl extends TaskExecutionInfoControllerBase 
{
	public TaskExecutionInfoControllerImpl(Session session)
	{
		super(session);
	}
	public TaskExecutionInfoControllerImpl(Session session, JsonObject standardReqParams)
	{
		super(session, standardReqParams);
	}
	public TaskExecutionInfoControllerImpl()
	{
		super();
	}
	...
	public void doAfterEntityLoadedImpl(TaskExecutionInfo taskExecutionInfo, JsonObject initParamsInfo)
	{
		//Custom handling	
	}
	...
	public JsonObject doExecuteAPIRequestImpl(String apiName, JsonObject taskExecutionInfoDataObject, TaskExecutionInfo taskExecutionInfo)
	{
		// Custom handling
	...
	public void doAfterLookupRowSelectedImpl(TaskExecutionInfo taskExecutionInfo, String attributeName)
	{
		//Custom handling	
	}
	public void doAfterSelectOptionChangedImpl(TaskExecutionInfo taskExecutionInfo, String attributeName)
	{
		//Custom handling	
	}
