...
public abstract class TaskScheduleInfoControllerBase extends BusinessRulesController
{
	...
	{
		com.shoppingcart.bean.TaskScheduleInfo entityBean = (TaskScheduleInfo)entityObject;
...
//			executeAction(taskScheduleInfo, "TaskScheduleInfoBean", currentStatus);
	...
	
	{
		...
		try
		{
			for (int i =0; i < taskScheduleInfoList.size(); i++)
			{
				...
				com.shoppingcart.controller.forms.impl.TaskScheduleInfoControllerImpl taskScheduleInfoImplObj = new com.shoppingcart.controller.forms.impl.TaskScheduleInfoControllerImpl(session, getUserSessionInfo());				
	...
	public int getEntityInfoUpdatedWithLookupIds(Session session, JsonObject taskScheduleInfo, JsonObject retValObject)
	{
		...
		int hasParamsForLookup = 0;
				hasParamsForLookup = com.shoppingcart.controller.forms.impl.TaskInfoControllerImpl.hasParamsForLookup(taskScheduleInfo, "taskInfo");
		...
		{
			dataObject = com.shoppingcart.controller.forms.impl.TaskInfoControllerImpl.getQueryParamsForLookupSearch(taskScheduleInfo, "taskInfo");
