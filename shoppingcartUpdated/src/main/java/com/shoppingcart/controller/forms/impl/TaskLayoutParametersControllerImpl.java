...
import com.shoppingcart.controller.forms.base.TaskLayoutParametersLabel;
import com.shoppingcart.controller.forms.base.TaskLayoutParametersControllerBase;
 ...
 * 
 */
/*@ManagedBean(name = "TaskLayoutParametersControllerImpl")
@RequestScoped*/
public class TaskLayoutParametersControllerImpl extends TaskLayoutParametersControllerBase 
{
	public TaskLayoutParametersControllerImpl(Session session)
	{
		super(session);
	}
	public TaskLayoutParametersControllerImpl(Session session, JsonObject standardReqParams)
	{
		super(session, standardReqParams);
	}
	public TaskLayoutParametersControllerImpl()
	{
		super();
	}
	...
	public void doAfterEntityLoadedImpl(TaskLayoutParameters taskLayoutParameters, JsonObject initParamsInfo)
	{
		//Custom handling	
	}
	...
	public JsonObject doExecuteAPIRequestImpl(String apiName, JsonObject taskLayoutParametersDataObject, TaskLayoutParameters taskLayoutParameters)
	{
		// Custom handling
	...
	public void doAfterLookupRowSelectedImpl(TaskLayoutParameters taskLayoutParameters, String attributeName)
	{
		//Custom handling	
	}
	public void doAfterSelectOptionChangedImpl(TaskLayoutParameters taskLayoutParameters, String attributeName)
	{
		//Custom handling	
	}
