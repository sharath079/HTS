...
import com.shoppingcart.controller.forms.base.UserInfoControllerBase;
...
import com.shoppingcart.util.OrganisationsUtil;
import com.google.gson.JsonObject;
 ...
 * 
 */
/*@ManagedBean(name = "UserInfoControllerImpl")
@RequestScoped*/
public class UserInfoControllerImpl extends UserInfoControllerBase 
{
	public UserInfoControllerImpl(Session session)
	{
		super(session);
	}
	public UserInfoControllerImpl(Session session, JsonObject standardReqParams)
	{
...
public void doBeforeCreateTransactionImpl(JsonObject paramsInfoObj)
{
	...
	try
	{
		passwordHash = CommonUtil.getHash(loginPassword);	
	}
	catch (Exception e) {
		e.printStackTrace();
		return;
	...
	int isLoginIdRegistered = CommonUtil.isLoginIdRegistered(session, userSessionInfo, loginId);
	if(isLoginIdRegistered == 1)
	{
		addCustomResponse("A user with this contact no/user id already exists.");
	}
}
	...
	public void doAfterEntityLoadedImpl(UserInfo userInfo, JsonObject initParamsInfo)
	{
		//Custom handling	
	}
	...
	public JsonObject doExecuteAPIRequestImpl(String apiName, JsonObject userInfoDataObject, UserInfo userInfo)
	{
		// Custom handling
	...
	public void doAfterLookupRowSelectedImpl(UserInfo userInfo, String attributeName)
	{
		//Custom handling	
	}
	public void doAfterSelectOptionChangedImpl(UserInfo userInfo, String attributeName)
	{
		//Custom handling	
	}
