...
import com.shoppingcart.controller.forms.base.UserCartControllerBase;
 ...
 * 
 */
/*@ManagedBean(name = "UserCartControllerImpl")
@RequestScoped*/
public class UserCartControllerImpl extends UserCartControllerBase 
{
	public UserCartControllerImpl(Session session)
	{
		super(session);
	}
	public UserCartControllerImpl(Session session, JsonObject standardReqParams)
	{
	...
	public void doAfterEntityLoadedImpl(UserCart userCart, JsonObject initParamsInfo)
	{
		//Custom handling	
	}
	...
	public JsonObject doExecuteAPIRequestImpl(String apiName, JsonObject userCartDataObject, UserCart userCart)
	{
		// Custom handling
	...
	public void doAfterLookupRowSelectedImpl(UserCart userCart, String attributeName)
	{
		//Custom handling	
	}
	public void doAfterSelectOptionChangedImpl(UserCart userCart, String attributeName)
	{
		//Custom handling	
	}
	...
	public void doUpdateUserCart(Session session)
	{
