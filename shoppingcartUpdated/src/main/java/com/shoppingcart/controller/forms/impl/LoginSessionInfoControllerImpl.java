...
import com.shoppingcart.bean.LoginSessionInfo;
...
import com.shoppingcart.controller.forms.base.LoginSessionInfoLabel;
import com.shoppingcart.controller.forms.base.LoginSessionInfoControllerBase;
 ...
 * 
 */
/*@ManagedBean(name = "LoginSessionInfoControllerImpl")
@RequestScoped*/
public class LoginSessionInfoControllerImpl extends LoginSessionInfoControllerBase 
{
	public LoginSessionInfoControllerImpl(Session session)
	{
		super(session);
	}
	public LoginSessionInfoControllerImpl(Session session, JsonObject standardReqParams)
	{
		super(session, standardReqParams);
	}
	public LoginSessionInfoControllerImpl()
	{
		super();
	}
	...
	public void doAfterEntityLoadedImpl(LoginSessionInfo loginSessionInfo, JsonObject initParamsInfo)
	{
		//Custom handling	
	}
	...
	public JsonObject doExecuteAPIRequestImpl(String apiName, JsonObject loginSessionInfoDataObject, LoginSessionInfo loginSessionInfo)
	{
		// Custom handling
	...
	public void doAfterLookupRowSelectedImpl(LoginSessionInfo loginSessionInfo, String attributeName)
	{
		//Custom handling	
	}
	public void doAfterSelectOptionChangedImpl(LoginSessionInfo loginSessionInfo, String attributeName)
	{
		//Custom handling	
	}
