...
public abstract class LoginSessionInfoControllerBase extends BusinessRulesController
{
	...
	{
		com.shoppingcart.bean.LoginSessionInfo entityBean = (LoginSessionInfo)entityObject;
	...
	
	{
		...
		try
		{
			for (int i =0; i < loginSessionInfoList.size(); i++)
			{
				...
				com.shoppingcart.controller.forms.impl.LoginSessionInfoControllerImpl loginSessionInfoImplObj = new com.shoppingcart.controller.forms.impl.LoginSessionInfoControllerImpl(session, getUserSessionInfo());				
