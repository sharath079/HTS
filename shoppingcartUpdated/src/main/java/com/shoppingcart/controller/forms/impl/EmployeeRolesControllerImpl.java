...
import com.shoppingcart.controller.forms.base.EmployeeRolesControllerBase;
 ...
 * 
 */
/*@ManagedBean(name = "EmployeeRolesControllerImpl")
@RequestScoped*/
public class EmployeeRolesControllerImpl extends EmployeeRolesControllerBase 
{
	public EmployeeRolesControllerImpl(Session session)
	{
		super(session);
	}
	public EmployeeRolesControllerImpl(Session session, JsonObject standardReqParams)
	{
		super(session, standardReqParams);
	}
	public EmployeeRolesControllerImpl()
	{
		super();
	}
	...
	public void doAfterEntityLoadedImpl(EmployeeRoles employeeRoles, JsonObject initParamsInfo)
	{
		//Custom handling	
	}
	...
	public JsonObject doExecuteAPIRequestImpl(String apiName, JsonObject employeeRolesDataObject, EmployeeRoles employeeRoles)
	{
		// Custom handling
	...
	public void doAfterLookupRowSelectedImpl(EmployeeRoles employeeRoles, String attributeName)
	{
		//Custom handling	
	}
	public void doAfterSelectOptionChangedImpl(EmployeeRoles employeeRoles, String attributeName)
	{
		//Custom handling	
	}
