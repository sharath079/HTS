...
import com.shoppingcart.bean.ConfigProperties;
...
import com.shoppingcart.controller.forms.base.ConfigPropertiesLabel;
import com.shoppingcart.controller.forms.base.ConfigPropertiesControllerBase;
 ...
 * 
 */
/*@ManagedBean(name = "ConfigPropertiesControllerImpl")
@RequestScoped*/
public class ConfigPropertiesControllerImpl extends ConfigPropertiesControllerBase 
{
	public ConfigPropertiesControllerImpl(Session session)
	{
		super(session);
	}
	public ConfigPropertiesControllerImpl(Session session, JsonObject standardReqParams)
	{
	...
	public void doAfterEntityLoadedImpl(ConfigProperties configProperties, JsonObject initParamsInfo)
	{
		//Custom handling	
	}
	...
	public JsonObject doExecuteAPIRequestImpl(String apiName, JsonObject configPropertiesDataObject, ConfigProperties configProperties)
	{
		// Custom handling
	...
	public void doAfterLookupRowSelectedImpl(ConfigProperties configProperties, String attributeName)
	{
		//Custom handling	
	}
	public void doAfterSelectOptionChangedImpl(ConfigProperties configProperties, String attributeName)
	{
		//Custom handling	
	}
