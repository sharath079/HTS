...
import com.shoppingcart.controller.forms.base.OrdersControllerBase;
 ...
 * 
 */
/*@ManagedBean(name = "OrdersControllerImpl")
@RequestScoped*/
public class OrdersControllerImpl extends OrdersControllerBase 
{
	public OrdersControllerImpl(Session session)
	{
		super(session);
	}
	public OrdersControllerImpl(Session session, JsonObject standardReqParams)
	{
	...
	public void doAfterEntityLoadedImpl(Orders orders, JsonObject initParamsInfo)
	{
		//Custom handling	
	}
	...
	public JsonObject doExecuteAPIRequestImpl(String apiName, JsonObject ordersDataObject, Orders orders)
	{
		// Custom handling
	...
	public void doAfterLookupRowSelectedImpl(Orders orders, String attributeName)
	{
		//Custom handling	
	}
	public void doAfterSelectOptionChangedImpl(Orders orders, String attributeName)
	{
		//Custom handling	
	}
