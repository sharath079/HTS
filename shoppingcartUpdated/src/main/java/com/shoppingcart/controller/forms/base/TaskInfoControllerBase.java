...
public abstract class TaskInfoControllerBase extends BusinessRulesController
{
	...
	{
		com.shoppingcart.bean.TaskInfo entityBean = (TaskInfo)entityObject;
		...
		if(taskInfoListObject!=null && taskInfoListObject.has("success") && taskInfoListObject.get("success").getAsInt()==1)
		{
			...
			for (int i =0; i< taskInfoList.size(); i++)
			{
				...
				int taskInfoId = taskInfoDataObject.get("taskInfoId").getAsInt();
								com.shoppingcart.controller.forms.impl.TaskExecutionInfoControllerImpl taskExecutionInfoImplObj = new com.shoppingcart.controller.forms.impl.TaskExecutionInfoControllerImpl(getDBSession(), getUserSessionInfo());
				...
				com.shoppingcart.controller.forms.impl.TaskLayoutParametersControllerImpl taskLayoutParametersImplObj = new com.shoppingcart.controller.forms.impl.TaskLayoutParametersControllerImpl(getDBSession(), getUserSessionInfo());
				...
				com.shoppingcart.controller.forms.impl.EmailAttachmentLayoutControllerImpl emailAttachmentLayoutImplObj = new com.shoppingcart.controller.forms.impl.EmailAttachmentLayoutControllerImpl(getDBSession(), getUserSessionInfo());
	...
	public int  areSomeRecordsUploaded(JsonObject previousRetryCountMap, JsonObject retryCountMap) throws Exception
	{
		...
		if(retryCount<previousRetryCount)
		{
			return 1;
	    		...
	    		com.shoppingcart.controller.forms.impl.TaskExecutionInfoControllerImpl taskExecutionInfoImplObj = new com.shoppingcart.controller.forms.impl.TaskExecutionInfoControllerImpl(getDBSession());
		areSomeRecordsUploaded = 0;
		if(areSomeRecordsUploaded==1)
		{
			return 1;
		}
		com.shoppingcart.controller.forms.impl.TaskLayoutParametersControllerImpl taskLayoutParametersImplObj = new com.shoppingcart.controller.forms.impl.TaskLayoutParametersControllerImpl(getDBSession());
		areSomeRecordsUploaded = 0;
		if(areSomeRecordsUploaded==1)
		{
			return 1;
		}
		com.shoppingcart.controller.forms.impl.EmailAttachmentLayoutControllerImpl emailAttachmentLayoutImplObj = new com.shoppingcart.controller.forms.impl.EmailAttachmentLayoutControllerImpl(getDBSession());
		areSomeRecordsUploaded = 0;
		if(areSomeRecordsUploaded==1)
		{
			return 1;
	...
	
	{
		...
		try
		{
			for (int i =0; i < taskInfoList.size(); i++)
			{
				...
				com.shoppingcart.controller.forms.impl.TaskInfoControllerImpl taskInfoImplObj = new com.shoppingcart.controller.forms.impl.TaskInfoControllerImpl(session, getUserSessionInfo());				
			    ...
			    {
				    JsonArray taskExecutionInfoList = taskInfo.get("taskExecutionInfoList").getAsJsonArray();
					com.shoppingcart.controller.forms.impl.TaskExecutionInfoControllerImpl taskExecutionInfoImplObj = new com.shoppingcart.controller.forms.impl.TaskExecutionInfoControllerImpl(session, getUserSessionInfo());
			    ...
			    {
				    JsonArray taskLayoutParametersList = taskInfo.get("taskLayoutParametersList").getAsJsonArray();
					com.shoppingcart.controller.forms.impl.TaskLayoutParametersControllerImpl taskLayoutParametersImplObj = new com.shoppingcart.controller.forms.impl.TaskLayoutParametersControllerImpl(session, getUserSessionInfo());
			    ...
			    {
				    JsonArray emailAttachmentLayoutList = taskInfo.get("emailAttachmentLayoutList").getAsJsonArray();
					com.shoppingcart.controller.forms.impl.EmailAttachmentLayoutControllerImpl emailAttachmentLayoutImplObj = new com.shoppingcart.controller.forms.impl.EmailAttachmentLayoutControllerImpl(session, getUserSessionInfo());
