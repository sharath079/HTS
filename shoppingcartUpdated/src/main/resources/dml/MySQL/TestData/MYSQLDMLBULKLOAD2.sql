...
SET v_max_child=$$MAX_CHILD_TXNS$$;
WHILE (v_counter_parent <= (v_max_parent*v_max_child)) DO
	INSERT INTO UserCart(UserCartId) VALUES(v_counter_parent);
	SET v_counter_parent=v_counter_parent+1;	
END WHILE;	
SET v_counter_parent=1;	
SET v_counter_child=1;
...
SET v_max_child=$$MAX_CHILD_TXNS$$;
WHILE (v_counter_parent <= (v_max_parent*v_max_child)) DO
	INSERT INTO CartItem(CartItemId) VALUES(v_counter_parent);
	SET v_counter_parent=v_counter_parent+1;	
END WHILE;	
SET v_counter_parent=1;	
SET v_counter_child=1;
...
SET v_max_child=$$MAX_CHILD_TXNS$$;
WHILE (v_counter_parent <= (v_max_parent*v_max_child)) DO
	INSERT INTO Products(ProductsId) VALUES(v_counter_parent);
	SET v_counter_parent=v_counter_parent+1;	
END WHILE;	
SET v_counter_parent=1;	
SET v_counter_child=1;
...
SET v_max_child=$$MAX_CHILD_TXNS$$;
WHILE (v_counter_parent <= (v_max_parent*v_max_child)) DO
	INSERT INTO Orders(OrdersId) VALUES(v_counter_parent);
	SET v_counter_parent=v_counter_parent+1;	
END WHILE;	
SET v_counter_parent=1;	
SET v_counter_child=1;
...
SET v_max_child=$$MAX_CHILD_TXNS$$;
WHILE (v_counter_parent <= (v_max_parent*v_max_child)) DO
	INSERT INTO OrderItem(OrderItemId) VALUES(v_counter_parent);
	SET v_counter_parent=v_counter_parent+1;	
END WHILE;	
